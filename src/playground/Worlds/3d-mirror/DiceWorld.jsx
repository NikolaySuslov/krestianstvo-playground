...
export default function Scene(props) {
  ...
  createEffect(() => {
    ...
    setTimeout(() => {
      props.selo.callAction("wa6", "setProperty", ["rotation", props.start.includes("mirror") ? [0, Math.PI / 2, isNaN(parseFloat(props.start.slice(6))) ? 0.2 : props.start.slice(6)] : [0, Math.PI / 2, 0]])
